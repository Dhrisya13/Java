...
public class SearchAlgoMain {
   ...
   public static void main(String[] args) {
       ...
       int res1 = linearSearch(arr, target);
          if (res1 != -1)
             System.out.println("Element is found at index:"+res1);
          else
       ...
       Arrays.sort(arr);
          ...
          System.out.println("\n---Simple binary search Result---");
             int res2 = binarySearchSimple(arr, target);
          if (res2 != -1)
             System.out.println("Element is found at index:"+res2);
          else
             System.out.println("Element not found:");
             
          System.out.println("\n---Recursive Binary Search Result---");
             int res3 = binarySearchRecursive(arr, 0, n-1, target);
          if (res3 != -1)
             System.out.println("Element is found at index:"+res3);
          else
             System.out.println("Element not found:");
          }
        }
